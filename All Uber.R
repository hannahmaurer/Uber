...
#setwd('C:/Users/hanna/Documents/DATA 332/Uber')
...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      dateRangeInput("date_range", "Date Range", start = min(AllUber$Date), end = max(AllUber$Date))
    ),
    mainPanel(
      tabsetPanel(
